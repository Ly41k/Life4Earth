...
fun StellarSkyView(
    ...
    val planetRandomizers = remember { generateRandomPlanetDataset(planetData = planetData) }
    val starRandomizers = remember { generateRandomStarDataset(starData = starData) }
...
private fun drawGalaxy(
    ...
    starRandomizers.forEach {
        drawStar(
            drawScope = drawScope,
            sideLength = it.starCoefficientsData.sideLengthCoefficient * 2f,
            numberOfEdges = (it.starCoefficientsData.edgeNumberCoefficient * 24).toInt(),
...
private fun drawStar(
    ...
    for (i in (1..numberOfEdges)) {
        ...
        val secondPointRotationAngleInRadians = toRadians(
        ...
        val thirdPointRotationAngleInRadians = toRadians(
